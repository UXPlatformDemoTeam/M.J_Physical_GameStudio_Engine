...
import demo.MainGame.Screen_MainGame;
...
public class GL_Camera2D {
	...
	public void setParticleViewportAndMatrices(Screen_MainGame world) {
		GL10 gl = glGraphics.getGL();

		gl.glViewport(
				(int) (bounds.lowerLeft.x / world.getGameWidth() * glGraphics
						.getWidth()),
				(int) (bounds.lowerLeft.y / world.getGameHeight() * glGraphics
						.getHeight()),
				(int) (bounds.width / world.getGameWidth() * glGraphics
						.getWidth()),
				(int) (bounds.height / world.getGameHeight() * glGraphics
						.getHeight()));
