...
public class Object_Normal {
	...
	private float fObjWidth;
	private float fObjHeight;

	public Object_Normal(int flag, float center_x, float center_y, float width,
			float height) {
		this.fObjWidth = width;
		this.fObjHeight = height;
	...
	public Object_Normal(int flag, float center_x, float center_y, float radious) {
		...
		this.bounds = null;
		this.radious_bounds = new Math_Overlap_Circle(center_x, center_y,
				radious);
		this.image_flag = flag;
		intialize(center_x, center_y);
	}
	...
	public float getfObjWidth() {
		return fObjWidth;
	}

	public void setfObjWidth(float fObjWidth) {
		this.fObjWidth = fObjWidth;
	}

	public float getfObjHeight() {
		return fObjHeight;
	}

	public void setfObjHeight(float fObjHeight) {
		this.fObjHeight = fObjHeight;
	}
