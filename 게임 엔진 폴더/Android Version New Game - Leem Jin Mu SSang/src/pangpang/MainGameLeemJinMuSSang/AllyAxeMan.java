...
public class AllyAxeMan extends Ally {

	public static final float ALLY_AXE_WIDTH = 100f;
	public static final float ALLY_AXE_HEIGHT = 100f;

	public static final float ALLY_AXE_WIDTH_R = 80f;
	public static final float ALLY_AXE_HEIGHT_R = 100f;
	...
	public AllyAxeMan(float center_x, float center_y,int health, float speed) {
		super(center_x, center_y, ALLY_AXE_WIDTH, ALLY_AXE_HEIGHT, health);
		...
		this.attackBounds = new Math_Overlap_Rectangle(center_x
				- ALLY_AXE_WIDTH_R / 2, center_y - ALLY_AXE_HEIGHT_R
				/ 2, ALLY_AXE_WIDTH_R, ALLY_AXE_HEIGHT_R);
	}
	...
	private void Attack() {
		...
		MainGame_Manager.allyAttackFiyld.add(new AttackFiyld(
				this.position.x + 85, this.position.y));
	}
