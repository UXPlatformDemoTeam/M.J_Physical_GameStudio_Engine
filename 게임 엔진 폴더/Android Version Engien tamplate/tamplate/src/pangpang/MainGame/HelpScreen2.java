...
public class HelpScreen2 extends GL_Screen {
	GL_Camera2D guiCam;
	...
	@Override
	public void resume() {
		helpImage = new GL_Texture(glGame, "help01.png");
	...
	public void update(float deltaTime) {
		...
		for (int i = 0; i < len; i++) {
			...
			if (event.type == TouchEvent.TOUCH_UP && 37 == buttons_Tag) {
	...
	public void present(float deltaTime) {
		...
		batcher.drawSprite(60, 270, 60, 60, Manage_Assets.textureRegion.get(buttons_Tag));
		batcher.endBatch();
