...
public class HelpScreen3 extends GL_Screen {
	GL_Camera2D guiCam;
	...
	public HelpScreen3(IFace_Game game) {
		super(game);
	...
	@Override
	public void resume() {
		helpImage = new GL_Texture(glGame, "help02.png");
	...
	public void present(float deltaTime) {
		...
		batcher.drawSprite(430, 270, 60, 60,
