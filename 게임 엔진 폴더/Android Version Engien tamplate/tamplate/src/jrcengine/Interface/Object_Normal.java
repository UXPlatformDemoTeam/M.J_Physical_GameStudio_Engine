...
public class Object_Normal {
    ...
    private final Math_Overlap_Circle radious_bounds;
    ...
    public Object_Normal(int flag, float center_x, float center_y, float width, float height) {
        this.bounds = new Math_Overlap_Rectangle(center_x - width / 2, center_y - height / 2,
                width, height);
    ...
    public Object_Normal(float center_x, float center_y, float width, float height, int... flags) {
        this.bounds = new Math_Overlap_Rectangle(center_x - width / 2, center_y - height / 2,
                width, height);
        this.radious_bounds = null;
    ...
    public Object_Normal(float center_x, float center_y, float radious) {
        this.bounds = null;
        this.radious_bounds = new Math_Overlap_Circle(center_x, center_y, radious);
        intialize(center_x, center_y);
    }

    public Object_Normal(float center_x, float center_y, float width, float height) {
        this.bounds = new Math_Overlap_Rectangle(center_x - width / 2, center_y - height / 2,
                width, height);
        this.radious_bounds = null;
    ...
    public Math_Overlap_Circle getRadious_bounds() {
        return radious_bounds;
    }
