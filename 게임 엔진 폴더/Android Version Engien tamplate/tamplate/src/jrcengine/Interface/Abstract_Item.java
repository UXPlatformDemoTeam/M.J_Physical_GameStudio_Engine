...
public abstract class Abstract_Item extends Object_Normal {
    ...
    public Abstract_Item(String name_Item, int item_Image_Number, int item_Price, float center_X,
    ...
    public void update(float deltaTime) {
        getBounds().getLowerLeft().set(getPosition())
                .sub(getBounds().getWidth() / 2, getBounds().getHeight() / 2);
        stateTime += deltaTime;
    }
